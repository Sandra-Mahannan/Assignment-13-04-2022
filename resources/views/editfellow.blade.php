...
<html lang="en">
  ...
  <body>
      ...
      <form action="/update/{{$fellow->id}}" method="post">
          
          @csrf
        <div class="col-md-4">
          <label class="form-label">First Name</label>
          <input type="text" name="fname" class="form-control" value="{{$fellow->fname}}">
        </div>
        <div class="col-md-4">
          <label class="form-label">Surname</label>
          <input type="text" name="lname" class="form-control" value="{{$fellow->lname}}">
        </div>
